...
func main() {
	...
	// 上传 URL 文件
	h.POST("/upload/url", func(ctx context.Context, c *app.RequestContext) {
		url := c.Query("url")
		fileName := c.Query("file_name")
	...
	// 分片上传
	h.POST("/upload/fragment", func(ctx context.Context, c *app.RequestContext) {
		fileName := c.Query("file_name")
	...
	// 文件下载
	h.GET("/download/browser", func(ctx context.Context, c *app.RequestContext) {
		fileName := c.Query("file_name")
	...
	// 查询下载进度
	h.GET("/download/progress", func(ctx context.Context, c *app.RequestContext) {
